...
class LoginRecoveryPasswordEvent extends LoginEvents {
  ...
  LoginRecoveryPasswordEvent(this.username, this.otpCode);
}

class LoginOtpValidationEvent extends LoginEvents {
  final String username;
  final String otpCode;

  LoginOtpValidationEvent({required this.username, required this.otpCode});
}

class LoginOtpRequestMessageEvent extends LoginEvents {
  final String username;

  LoginOtpRequestMessageEvent(this.username);
}
