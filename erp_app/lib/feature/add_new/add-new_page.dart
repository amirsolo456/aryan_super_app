...
class _AddNewPageState extends State<AddNewPage> {
  ...
  List<ResponseData> _leafMenus = [];
  List<ResponseData> _filteredMenus = [];
  ...
  List<ResponseData> _extractLeafMenus(List<ResponseData> menus) {
    final List<ResponseData> result = [];

    void traverse(ResponseData menu) {
