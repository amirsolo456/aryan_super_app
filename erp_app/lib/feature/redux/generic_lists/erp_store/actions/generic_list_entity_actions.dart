...
import '../models/generic_list_entity_state.dart' show GenericListEntityState;
...
class FetchDataSuccessAction<T extends BaseResponse<D>, D, C extends BaseRequest>
...
class InitializeEntityAction<T extends BaseResponse<D>, D, C extends BaseRequest>
    extends GenericEntityAction {
  final String entityKey;
  final C request;
  final T response;
